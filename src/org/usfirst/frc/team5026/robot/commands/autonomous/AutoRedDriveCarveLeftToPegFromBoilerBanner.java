...
public class AutoRedDriveCarveLeftToPegFromBoilerBanner extends CommandGroup {
    ...
    public AutoRedDriveCarveLeftToPegFromBoilerBanner() {
    	...
    	addSequential(new AutoDriveDistancePositionBanner("Auto Boiler Extra Distance Red", "Auto Boiler Extra Distance Red", Constants.AUTO_BOILER_STRAIGHT_COUNT_RED));
        // Add Commands here:
