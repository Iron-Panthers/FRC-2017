...
public class MotionProfileSmallCurve {
	...
	public boolean reticulateSplines(double x0, double y0, double theta0, double x1, double y1, double theta1) {
		...
		double theta0_hat = ChezyMath.getDifferenceInAngleRadians(theta_offset_, theta0);
		double theta1_hat = ChezyMath.getDifferenceInAngleRadians(theta_offset_, theta1);
